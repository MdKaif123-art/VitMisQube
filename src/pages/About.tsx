...
const team = [
  {
    ...
    bio: 'Software Engineering student with a passion for creating tools that help students.',
    img: createrImg,
    github: 'http://github.com/MdKaif123-art/',
    linkedin: 'https://www.linkedin.com/in/k-mohammed-kaif-62510728b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
  },
];
...
const About = () => (
  <div className="max-w-6xl mx-auto px-2 md:px-6">
    ...
    {/* Developer */}
    <div className="bg-black rounded-xl shadow p-8 mb-10 border border-[#00FFFF]">
      ...
      <div className="flex flex-col items-center">
        <div className="bg-black rounded-xl shadow border border-[#00FFFF] p-8 flex flex-col items-center text-center hover:shadow-[0_0_15px_rgba(0,255,255,0.3)] transition-all max-w-xl">
          <img src={createrImg} alt="Mohammed Kaif K" className="w-24 h-24 rounded-full object-cover mb-4 border-4 border-[#008080] shadow" />
          <div className="font-bold text-[#00FFFF] text-xl mb-2">Mohammed Kaif K</div>
          <div className="text-[#00BFFF] text-md mb-2">Founder & Developer</div>
          ...
          <div className="flex gap-6 mt-2">
            <a href="http://github.com/MdKaif123-art/" 
              ...
              className="flex items-center gap-2 text-white hover:text-[#00FFFF] bg-black/30 backdrop-blur-sm px-4 py-2 rounded-lg border border-[#008080]/30 transition-all duration-300 hover:border-[#00FFFF] hover:shadow-[0_0_20px_rgba(0,255,255,0.4)] hover:scale-105">
